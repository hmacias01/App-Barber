...
Router.post('/add', async (req, res) =>{
    ...
    const queryString = "INSERT INTO usuario (Nombres, Apellidos, Usuario, Password, Id_rol) VALUES (?,?,?,?,(SELECT Idrol FROM roles WHERE rol = ?)) "
    pool.query(queryString, [Nombres, Apellidos, Usuario, Password, Id_rol], (err, results, fields) =>{
        if (err){
