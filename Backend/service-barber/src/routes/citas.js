...
Router.get('/get/:id', (req, res) => {
    ...
    const queryString = "SELECT c.Fecha, c.Inicio,c.Final,c.Estatus, c.Id_usuario AS Id_Usuario,bar.Nombre as barberias,s.Nombre FROM servicios as s INNER join citas as c on c.Id_Servicio = s.IdServicio INNER JOIN barberias as bar on c.Id_Barberia = bar.IdBarberia  where c.Id_Usuario=?"
